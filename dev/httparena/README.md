...
`dev.cardigan:cardigan:0.1.0-alpha1` artifact. Cardigan itself owns no
...
Build and test it directly from Maven Central:
...
repository. To prepare a submission, copy all six `cardigan*` directories from
this directory into an HttpArena checkout's `frameworks/` directory.
